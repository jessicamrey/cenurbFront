...
module.exports = "  <p style=\"margin-top:80px;\"></p>\n    <ngx-alerts></ngx-alerts>\n    <ngx-loading [show]=\"loading\" [config]=\"{backdropBorderRadius: '14px'}\"></ngx-loading>\n\n     <div class=\"row\" >\n        <div class=\"col-xl-3 col-lg-6\">\n            <app-stat [bgClass]=\"'primary'\" [icon]=\"'fa-comments'\" count=\"{{numEspecies}}\" label=\"{{ 'Dashboard.numEspecies' | translate }}\" ></app-stat>\n        </div>\n        <div class=\"col-xl-3 col-lg-6\">\n            <app-stat [bgClass]=\"'warning'\" [icon]=\"'fa-tasks'\" count=\"{{numCol}}\" label=\"{{ 'Dashboard.numCol' | translate }} {{year}}\" ></app-stat>\n        </div>\n        <div class=\"col-xl-3 col-lg-6\">\n            <app-stat [bgClass]=\"'success'\" [icon]=\"'fa-shopping-cart'\" count=\"{{numTerr}}\" label=\"{{ 'Dashboard.numTerr' | translate }} {{year}}\" ></app-stat>\n        </div>\n        <div class=\"col-xl-3 col-lg-6\">\n            <app-stat [bgClass]=\"'danger'\" [icon]=\"'fa-support'\" count=\"{{numUsers}}\" label=\"{{ 'Dashboard.numUsers' | translate }}\"></app-stat>\n        </div>\n    </div>\n\n    <div class=\"row\" style=\"margin-top:40px\">\n       \n\n      \n        <div class=\"col-sm-3\" style=\"height: 100px\" *ngFor=\"let item of listaCol\" id=\"{{item.ID_ESP}}\">\n\n           <div  *ngIf=\"translate.currentLang=='es'\" class=\"card text-white  mb-3\" style=\"background-color: #1d5d83\">\n\n                <img  src= '{{item.image}}' style=\"max-width:100%;max-height: :100%\" (click)=\"seleccionar(item.DEN_ESP_CAS, item.ID_ESP)\"/>\n\n                <div class=\"card-footer\">\n                    {{item.DEN_ESP_CAS}}\n                </div>\n            </div>\n\n            <div  *ngIf=\"translate.currentLang=='en'\" class=\"card text-white  mb-3\" style=\"background-color: #1d5d83\">\n\n                <img  src= '{{item.image}}' style=\"max-width:100%;max-height: :100%\" (click)=\"seleccionar(item.DEN_ESP_ING, item.ID_ESP)\"/>\n\n                <div class=\"card-footer\">\n                    {{item.DEN_ESP_ING}}\n                </div>\n            </div>\n\n            <div  *ngIf=\"translate.currentLang=='cat'\" class=\"card text-white  mb-3\" style=\"background-color: #1d5d83\">\n\n                <img  src= '{{item.image}}' style=\"max-width:100%;max-height: :100%\" (click)=\"seleccionar(item.DEN_ESP_CAT, item.ID_ESP)\"/>\n\n                <div class=\"card-footer\">\n                    {{item.DEN_ESP_CAT}}\n                </div>\n            </div>\n\n            <div  *ngIf=\"translate.currentLang=='gal'\" class=\"card text-white  mb-3\" style=\"background-color: #1d5d83\">\n\n                <img  src= '{{item.image}}' style=\"max-width:100%;max-height: :100%\" (click)=\"seleccionar(item.DEN_ESP_GAL, item.ID_ESP)\"/>\n\n                <div class=\"card-footer\">\n                    {{item.DEN_ESP_GAL}}\n                </div>\n            </div>\n\n            <div  *ngIf=\"translate.currentLang=='eus'\" class=\"card text-white  mb-3\" style=\"background-color: #1d5d83\">\n\n                <img  src= '{{item.image}}' style=\"max-width:100%;max-height: :100%\" (click)=\"seleccionar(item.DEN_ESP_VAS, item.ID_ESP)\"/>\n\n                <div class=\"card-footer\">\n                    {{item.DEN_ESP_VAS}}\n                </div>\n            </div>\n\n            \n        </div>\n   \n  \n\n \n</div>\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_seo_apis_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../services/seo-apis.service */ "./src/services/seo-apis.service.ts");
/* harmony import */ var _services_colonias_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/colonias.service */ "./src/services/colonias.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.recuperaColoniales = function () {
        ...
        this.seoService.listaColoniales().subscribe(function (data) {
            _this.loading = false;
            _this.listaCol = data;
            _this.numEspecies = _this.listaCol.length;
    ...
    DashboardComponent.prototype.dashboardData = function () {
        var _this = this;
        var date = new Date();
        var year = date.getFullYear();
        this.coloniasService.getDashboardData(year).subscribe(function (data) {
            console.log(data);
            _this.numCol = data[0][0]['1'];
            _this.numTerr = data[1][0]['1'];
            _this.numUsers = data[2][0]['1'];
        }, function (error) {
            console.log(error);
            _this.alertService.danger(_this.translate.instant("Dashboard.errorGetCol"));
        });
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"],
            _services_seo_apis_service__WEBPACK_IMPORTED_MODULE_1__["SeoApisService"],
            _services_colonias_service__WEBPACK_IMPORTED_MODULE_2__["ColoniasService"],
...
/* harmony import */ var _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dashboard-routing.module */ "./src/app/layout/dashboard/dashboard-routing.module.ts");
/* harmony import */ var _dashboard_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dashboard.component */ "./src/app/layout/dashboard/dashboard.component.ts");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components */ "./src/app/layout/dashboard/components/index.ts");
    ...
    DashboardModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _components__WEBPACK_IMPORTED_MODULE_7__["TimelineComponent"],
                _components__WEBPACK_IMPORTED_MODULE_7__["NotificationComponent"],
                _components__WEBPACK_IMPORTED_MODULE_7__["ChatComponent"]
            ]
        })
    ], DashboardModule);
