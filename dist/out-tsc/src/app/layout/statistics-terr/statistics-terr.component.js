...
var StatisticsTerrComponent = /** @class */ (function () {
    function StatisticsTerrComponent(translate, territoriosService, alertService, seoService) {
    ...
    StatisticsTerrComponent.prototype.ngOnInit = function () {
        this.statsAnno();
        this.statsCcca();
    };
    StatisticsTerrComponent.prototype.statsAnno = function () {
        var _this = this;
        var dataList = [];
        //TODO: recuperar especie de localstorage, recuperar temporada de nueva entidad
        this.territoriosService.getStatsAnno(this.especie, 2019).subscribe(function (data) {
            console.log(data);
    ...
    StatisticsTerrComponent.prototype.statsCcca = function () {
        //Primero recuperamos todas las comunidades, ya que tienen que estar todas en el grafico, aunque su dato sea 0
        this.recuperaCCAA();
    };
    StatisticsTerrComponent.prototype.statsProvincia = function () {
        var _this = this;
        this.loading = true;
        var finish = this.listaCCAA.length;
        var init = 0;
        var _loop_1 = function (ccaa) {
            this_1.territoriosService.getStatsProvincia(this_1.especie, 2019, ccaa["DEN_COM"]).subscribe(function (data) {
                var dataList = [];
    ...
    StatisticsTerrComponent.prototype.recuperaCCAA = function () {
        var _this = this;
        var dataList = [];
        this.seoService.getCCAA().subscribe(function (data) {
            ...
            _this.territoriosService.getStatsCcaa(_this.especie, 2019).subscribe(function (data) {
    ...
    StatisticsTerrComponent.prototype.recuperaProvincia = function (idCom, den) {
        var _this = this;
    ...
    StatisticsTerrComponent.prototype.recuperaTemporadas = function () {
    };
    StatisticsTerrComponent = __decorate([
        core_1.Component({
    ...
    return StatisticsTerrComponent;
}());
exports.StatisticsTerrComponent = StatisticsTerrComponent;
//# sourceMappingURL=statistics-terr.component.js.map